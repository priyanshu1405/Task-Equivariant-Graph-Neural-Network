...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str,
                        default="ogbn-arxiv", choices=['Amazon_clothing', 'Amazon_electronics', 'corafull', 'dblp', 'coauthorCS', 'ogbn-arxiv', 'CiteSeer'])
    ...
    parser.add_argument("--way", type=int, default=3)  # N
